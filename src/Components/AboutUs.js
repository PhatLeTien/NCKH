...
import BannerLogo from '../Assets/Banner-PTGAMES.png';
  ...
  return (
    <div className="about-container">
      ...
      <div className="logo-container">
        <img src={BannerLogo} alt="PTGames Logo" />
        <span>Image: PTGames</span>
      </div>
      <p className="about-content">
        Thank you for reading <i>PTGames</i>, a news and opinion site about games and things serious gamers care about. We’re here to inform you and, sometimes, entertain you. We also often write about pop culture topics like anime, TV, and movies: if it’s good, interesting, or inspires us somehow, we want to tell you about it.<br /><br />
        ...
        <b className="news-scoops">We crave news. We want scoops! So, please, tip your editors by emailing: <u>tips@PTGames.com</u></b>
      </p>
