...
const EntertainmentContent = () => {
    ...
    const openDetail = (article) => {
        navigate(`/entertainment/article/${article.id}`);
    };
        ...
        <div className="entertainment-container">
            ...
            <div className="entertainment-main-content">
                ...
                <div className="entertainment-side-articles">
                    {sideEntertainments.map((sideentertainments, index) => (
                        <div key={index} className="entertainment-side-article" onClick={() => openDetail(sideentertainments)}>
